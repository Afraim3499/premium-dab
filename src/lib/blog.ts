...
export const allBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'রাস্তার ডাবের দাম কত হয়?', answer: 'রাস্তায় সাধারণত নিম্নমানের ডাবই ৳১৩০ থেকে ৳১৫০ দরে বিক্রি হয়। সেই তুলনায় Premium Daab সম্পূর্ণ হাইজেনিক ডাব মাত্র ৳১২০-তে সরবরাহ করে।' },
