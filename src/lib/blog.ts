...
export const allBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'রাস্তার ডাবের চেয়ে আপনাদের দাম কম বা সাশ্রয়ী কেন?', answer: 'রাস্তার বিক্রেতারা মধ্যস্বত্বভোগী বা আড়তদারদের থেকে ডাব কেনেন যা দাম বাড়ায়। আমরা সরাসরি বাগান থেকে একই দিনে তাজা ডাব পেড়ে সংগ্রহ করি, তাই কোনো মধ্যস্বত্বভোগী না থাকায় কম মূল্যে প্রিমিয়াম ডাব দিতে পারি।' },
      { question: 'বেশি কিনলে ছাড় পাওয়া যায়?', answer: 'ডেলিভারি চার্জ সাশ্রয় হয়। ৬ পিসের প্যাকে প্রতি পিসে ৳১২০ হিসেবে ডেলিভারি চার্জ একবারই দিতে হয়।' },
    ],
  },
  {
